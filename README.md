...
- Providing recipes
- Facilitate the realization of your meals.
...
On the home page we have options to choose the type of diets, sort in ascending and descending order, sort by low or high healthScore, search for a particular recipe and create a recipe.

<img src="./homePage.png">

### Recipe Details

You can see the detail of the recipes:
